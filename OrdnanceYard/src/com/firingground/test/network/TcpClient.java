...
/**
 * Подключается к серверу и передает ему сообщения вводимые пользователем в консоли. Хост сервера
 * указывается первым аргументом, порт вторым. При отсутствии аргументов в качестве адреса порта
 * принимается localhost:9999
 */
public class TcpClient
{
	...
	public static void main( String[] args )
	{
		...
		/*
		 * Получаем поток вывода, через который будут передаваться сообщения серверу
		 */
		...
		/*
		 * Все вводимые пользователем сообщения будем транслировать в поток вывода созданного сокета
		 */
