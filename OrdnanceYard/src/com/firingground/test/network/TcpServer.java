...
public class TcpServer
{
	...
	public static void main( String[] args )
	{
		...
		/*
		 * Если порт был свободен и сокет был успешно создан, можно переходить к следующему шагу -
		 * ожиданию клинта
		 */
		...
		/*
		 * Теперь можно получить поток ввода, в который помещаются сообщения от клиента
		 */
		InputStream in = null;
		try
		{
		...
		/*
		 * В этой реализации сервер будет без конца читать поток и выводить его содержимое на
		 * консоль
		 */
